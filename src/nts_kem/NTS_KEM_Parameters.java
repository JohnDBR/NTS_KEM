...
public class NTS_KEM_Parameters
     ...
     */
    public static final int DEFAULT_L = 256;
     ...
     */
    public NTS_KEM_Parameters(int keysize) {
        this(keysize, null);
    }
     ...
     * @throws IllegalArgumentException if <tt>keysize &lt; 1</tt>.
     */
    public NTS_KEM_Parameters(int keysize, Digest digest) {
        if (keysize < 1) {
     ...
     */
    public NTS_KEM_Parameters(int m, int t) {
        this(m, t, null);
    }
     ...
     * <tt>t &lt; 0</tt> or <tt>t &gt; n</tt>.
     */
    public NTS_KEM_Parameters(int m, int t, Digest digest) {
        if (m < 1) {
     ...
     */
    public NTS_KEM_Parameters(int m, int t, int poly) {
        this(m, t, poly, null);
    }
     ...
     * <tt>poly</tt> is not an irreducible field polynomial.
     */
    public NTS_KEM_Parameters(int m, int t, int poly, Digest digest) {
        this.m = m;
        if (m < 1) {
            throw new IllegalArgumentException("m must be positive");
        }
