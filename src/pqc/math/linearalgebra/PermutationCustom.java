...
import pqc.math.linearalgebra.RandUtils;
 ...
 * once and only once.
 */
public class PermutationCustom
{
     ...
     */
    public PermutationCustom(int n)
    {
        if (n <= 0)
        {
     ...
     */
    public PermutationCustom(int[] perm)
    {
     ...
     */
    public PermutationCustom(byte[] enc)
    {
        if (enc.length <= 4)
        {
     ...
     */
    public PermutationCustom(int n, SecureRandom sr)
    {
        if (n <= 0)
        {
            throw new IllegalArgumentException("invalid length");
     ...
     */
    public PermutationCustom computeInverse()
    {
        PermutationCustom result = new PermutationCustom(perm.length);
     ...
     * @return <tt>this * p</tt>
     */
    public PermutationCustom rightMultiply(PermutationCustom p)
    {
 ...
 the same size of the permutation array.
    ...
    public boolean equals(Object other)
    {
        ...
        if (!(other instanceof PermutationCustom))
        {
            return false;
        }
        PermutationCustom otherPerm = (PermutationCustom)other;
